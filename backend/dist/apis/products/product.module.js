    ...
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([
                ...
                productImage_entity_1.ProductImage,
                productAllergy_entity_1.ProductAllergy,
                productSubCategory_entity_1.ProductSubCategory,
                productMainCategory_entity_1.ProductMainCategory,
                productNutritionFacts_entity_1.ProductNutritionFacts,
            ]),
        ],
        providers: [
