...
const updateUser_input_1 = require("../users/dto/updateUser.input");
let AuthResolver = class AuthResolver {
    constructor(userService, authService) {
        this.userService = userService;
        this.authService = authService;
    }
    async login(logId, password, context) {
        const user = await this.userService.findOne({ logId });
        if (!user)
            throw new common_1.UnprocessableEntityException('존재하지 않는 아이디입니다.');
    ...
    async updateUserPwd(currentUser, updateUserInput) {
        updateUserInput = Object.assign(Object.assign({}, updateUserInput), { password: await bcrypt.hash(updateUserInput.password, 10) });
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)('logId')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthResolver.prototype, "fetchLoginUser", null);
__decorate([
    (0, common_1.UseGuards)(gql_auth_guard_1.GqlAuthAccessGuard),
